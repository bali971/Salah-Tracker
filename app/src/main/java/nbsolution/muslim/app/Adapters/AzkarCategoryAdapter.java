...
import nbsolution.muslim.app.Models.AzkarModel;
        ...
        public MyAdapter(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    showAzkar(dbManagerAzkar.getAzkar(dataen.get(getAbsoluteAdapterPosition())), dataen.get(getAbsoluteAdapterPosition()));
                }
            });
