...
import nbsolution.muslim.app.Adapters.NextWeatherAdapter;
import nbsolution.muslim.app.Adapters.TodayWeatherAdapter;
import nbsolution.muslim.app.Models.WeatherModel;
...
public class WeatherWidget extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(WeatherWidget.this);
        } else {
