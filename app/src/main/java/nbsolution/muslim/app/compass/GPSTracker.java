...
public class GPSTracker extends Service implements LocationListener {
    ...
    private void sendLocalBroadCast(double longitude,double latitude) {
        LocalBroadcastManager localBroadcastManager = LocalBroadcastManager.getInstance(GPSTracker.this);
    ...
    /*public void setCityDetails(double longitude,double latitude) throws IOException {
        ...
        if (addresses != null && !addresses.isEmpty()) {
            ...
            SharedClass.setLocationFlag(this,countryName,cityName,latitude+"",longitude+"",1);
        }
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setPositiveButton(mContext.getResources().getString(R.string.btn_ok), new DialogInterface.OnClickListener() {
